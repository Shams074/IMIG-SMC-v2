    ...
    <>
      <div className="bg-gradient-to-br from-blue-900 to-blue-700 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-white mb-4">Journal Club</h1>
          <p className="text-white/70 text-lg max-w-xl">Coordinates research projects, publication support, and critical appraisal sessions.</p>
        </div>
      </div>
      <Section>
