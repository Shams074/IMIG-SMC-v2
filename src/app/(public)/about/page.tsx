          ...
          <div className="relative">
            ...
            <div className="flex flex-col gap-10 sm:gap-12">
              {Object.entries(
                ...
                <div key={year} className="relative flex flex-row gap-4 sm:gap-10 items-start">

              {/* Year Label (Left side) */}
              <div className="flex-shrink-0 w-14 sm:w-24 pt-1 text-right relative z-10">
              <span className="text-lg sm:text-2xl font-serif font-bold text-blue-900 bg-blue-50/50 pr-2">
                 {year}
                </span>
              </div>

              {/* Dot on the line */}
            <div className="absolute left-[52px] sm:left-[92px] top-3 w-2.5 h-2.5 rounded-full bg-blue-500 ring-4 ring-blue-50/50 z-10" />

                   {/* Items for this year (Right side) */}
                     <div className="flex-1 flex flex-col gap-4 w-full pl-4 sm:pl-0">
                    {items.map((item, i) => (
